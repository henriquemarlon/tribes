...
// CartesiDApp is an auto generated Go binding around an Ethereum crowdfunding.
type CartesiDApp struct {
	CartesiDAppCaller     // Read-only binding to the crowdfunding
	CartesiDAppTransactor // Write-only binding to the crowdfunding
	CartesiDAppFilterer   // Log filterer for crowdfunding events
}

// CartesiDAppCaller is an auto generated read-only Go binding around an Ethereum crowdfunding.
type CartesiDAppCaller struct {
	crowdfunding *bind.BoundContract // Generic crowdfunding wrapper for the low level calls
}

// CartesiDAppTransactor is an auto generated write-only Go binding around an Ethereum crowdfunding.
type CartesiDAppTransactor struct {
	crowdfunding *bind.BoundContract // Generic crowdfunding wrapper for the low level calls
}

// CartesiDAppFilterer is an auto generated log filtering Go binding around an Ethereum crowdfunding events.
type CartesiDAppFilterer struct {
	crowdfunding *bind.BoundContract // Generic crowdfunding wrapper for the low level calls
}

// CartesiDAppSession is an auto generated Go binding around an Ethereum crowdfunding,
// with pre-set call and transact options.
type CartesiDAppSession struct {
	Contract     *CartesiDApp      // Generic crowdfunding binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// CartesiDAppCallerSession is an auto generated read-only Go binding around an Ethereum crowdfunding,
// with pre-set call options.
type CartesiDAppCallerSession struct {
	Contract *CartesiDAppCaller // Generic crowdfunding caller binding to set the session for
	CallOpts bind.CallOpts      // Call options to use throughout this session
}

// CartesiDAppTransactorSession is an auto generated write-only Go binding around an Ethereum crowdfunding,
// with pre-set transact options.
type CartesiDAppTransactorSession struct {
	Contract     *CartesiDAppTransactor // Generic crowdfunding transactor binding to set the session for
	TransactOpts bind.TransactOpts      // Transaction auth options to use throughout this session
}

// CartesiDAppRaw is an auto generated low-level Go binding around an Ethereum crowdfunding.
type CartesiDAppRaw struct {
	Contract *CartesiDApp // Generic crowdfunding binding to access the raw methods on
}

// CartesiDAppCallerRaw is an auto generated low-level read-only Go binding around an Ethereum crowdfunding.
type CartesiDAppCallerRaw struct {
	Contract *CartesiDAppCaller // Generic read-only crowdfunding binding to access the raw methods on
}

// CartesiDAppTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum crowdfunding.
type CartesiDAppTransactorRaw struct {
	Contract *CartesiDAppTransactor // Generic write-only crowdfunding binding to access the raw methods on
}

// NewCartesiDApp creates a new instance of CartesiDApp, bound to a specific deployed crowdfunding.
func NewCartesiDApp(address common.Address, backend bind.ContractBackend) (*CartesiDApp, error) {
	crowdfunding, err := bindCartesiDApp(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &CartesiDApp{CartesiDAppCaller: CartesiDAppCaller{crowdfunding: crowdfunding}, CartesiDAppTransactor: CartesiDAppTransactor{crowdfunding: crowdfunding}, CartesiDAppFilterer: CartesiDAppFilterer{crowdfunding: crowdfunding}}, nil
}

// NewCartesiDAppCaller creates a new read-only instance of CartesiDApp, bound to a specific deployed crowdfunding.
func NewCartesiDAppCaller(address common.Address, caller bind.ContractCaller) (*CartesiDAppCaller, error) {
	crowdfunding, err := bindCartesiDApp(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &CartesiDAppCaller{crowdfunding: crowdfunding}, nil
}

// NewCartesiDAppTransactor creates a new write-only instance of CartesiDApp, bound to a specific deployed crowdfunding.
func NewCartesiDAppTransactor(address common.Address, transactor bind.ContractTransactor) (*CartesiDAppTransactor, error) {
	crowdfunding, err := bindCartesiDApp(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &CartesiDAppTransactor{crowdfunding: crowdfunding}, nil
}

// NewCartesiDAppFilterer creates a new log filterer instance of CartesiDApp, bound to a specific deployed crowdfunding.
func NewCartesiDAppFilterer(address common.Address, filterer bind.ContractFilterer) (*CartesiDAppFilterer, error) {
	crowdfunding, err := bindCartesiDApp(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &CartesiDAppFilterer{crowdfunding: crowdfunding}, nil
}

// bindCartesiDApp binds a generic wrapper to an already deployed crowdfunding.
...
func (_CartesiDApp *CartesiDAppRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _CartesiDApp.Contract.CartesiDAppCaller.crowdfunding.Call(opts, result, method, params...)
}
...
func (_CartesiDApp *CartesiDAppRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CartesiDApp.Contract.CartesiDAppTransactor.crowdfunding.Transfer(opts)
}
...
func (_CartesiDApp *CartesiDAppRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _CartesiDApp.Contract.CartesiDAppTransactor.crowdfunding.Transact(opts, method, params...)
}
...
func (_CartesiDApp *CartesiDAppCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _CartesiDApp.Contract.crowdfunding.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the crowdfunding, calling
// its default method if one is available.
func (_CartesiDApp *CartesiDAppTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CartesiDApp.Contract.crowdfunding.Transfer(opts)
}
...
func (_CartesiDApp *CartesiDAppTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _CartesiDApp.Contract.crowdfunding.Transact(opts, method, params...)
}

// GetConsensus is a free data retrieval call binding the crowdfunding method 0x179e740b.
//
...
func (_CartesiDApp *CartesiDAppCaller) GetConsensus(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _CartesiDApp.crowdfunding.Call(opts, &out, "getConsensus")
...
// GetTemplateHash is a free data retrieval call binding the crowdfunding method 0x61b12c66.
//
...
func (_CartesiDApp *CartesiDAppCaller) GetTemplateHash(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _CartesiDApp.crowdfunding.Call(opts, &out, "getTemplateHash")
...
// Owner is a free data retrieval call binding the crowdfunding method 0x8da5cb5b.
//
// Solidity: function owner() view returns(address)
func (_CartesiDApp *CartesiDAppCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _CartesiDApp.crowdfunding.Call(opts, &out, "owner")
...
// SupportsInterface is a free data retrieval call binding the crowdfunding method 0x01ffc9a7.
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_CartesiDApp *CartesiDAppCaller) SupportsInterface(opts *bind.CallOpts, interfaceId [4]byte) (bool, error) {
	var out []interface{}
	err := _CartesiDApp.crowdfunding.Call(opts, &out, "supportsInterface", interfaceId)
...
// ValidateNotice is a free data retrieval call binding the crowdfunding method 0x96487d46.
//
...
func (_CartesiDApp *CartesiDAppCaller) ValidateNotice(opts *bind.CallOpts, _notice []byte, _proof Proof) (bool, error) {
	var out []interface{}
	err := _CartesiDApp.crowdfunding.Call(opts, &out, "validateNotice", _notice, _proof)
...
// WasVoucherExecuted is a free data retrieval call binding the crowdfunding method 0x9d9b1145.
//
...
func (_CartesiDApp *CartesiDAppCaller) WasVoucherExecuted(opts *bind.CallOpts, _inputIndex *big.Int, _outputIndexWithinInput *big.Int) (bool, error) {
	var out []interface{}
	err := _CartesiDApp.crowdfunding.Call(opts, &out, "wasVoucherExecuted", _inputIndex, _outputIndexWithinInput)
...
// ExecuteVoucher is a paid mutator transaction binding the crowdfunding method 0x1250482f.
//
...
func (_CartesiDApp *CartesiDAppTransactor) ExecuteVoucher(opts *bind.TransactOpts, _destination common.Address, _payload []byte, _proof Proof) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.Transact(opts, "executeVoucher", _destination, _payload, _proof)
}
...
// MigrateToConsensus is a paid mutator transaction binding the crowdfunding method 0xfc411683.
//
...
func (_CartesiDApp *CartesiDAppTransactor) MigrateToConsensus(opts *bind.TransactOpts, _newConsensus common.Address) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.Transact(opts, "migrateToConsensus", _newConsensus)
}
...
// OnERC1155BatchReceived is a paid mutator transaction binding the crowdfunding method 0xbc197c81.
//
...
func (_CartesiDApp *CartesiDAppTransactor) OnERC1155BatchReceived(opts *bind.TransactOpts, arg0 common.Address, arg1 common.Address, arg2 []*big.Int, arg3 []*big.Int, arg4 []byte) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.Transact(opts, "onERC1155BatchReceived", arg0, arg1, arg2, arg3, arg4)
}
...
// OnERC1155Received is a paid mutator transaction binding the crowdfunding method 0xf23a6e61.
//
...
func (_CartesiDApp *CartesiDAppTransactor) OnERC1155Received(opts *bind.TransactOpts, arg0 common.Address, arg1 common.Address, arg2 *big.Int, arg3 *big.Int, arg4 []byte) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.Transact(opts, "onERC1155Received", arg0, arg1, arg2, arg3, arg4)
}
...
// OnERC721Received is a paid mutator transaction binding the crowdfunding method 0x150b7a02.
//
...
func (_CartesiDApp *CartesiDAppTransactor) OnERC721Received(opts *bind.TransactOpts, arg0 common.Address, arg1 common.Address, arg2 *big.Int, arg3 []byte) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.Transact(opts, "onERC721Received", arg0, arg1, arg2, arg3)
}
...
// RenounceOwnership is a paid mutator transaction binding the crowdfunding method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_CartesiDApp *CartesiDAppTransactor) RenounceOwnership(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.Transact(opts, "renounceOwnership")
}
...
// TransferOwnership is a paid mutator transaction binding the crowdfunding method 0xf2fde38b.
//
...
func (_CartesiDApp *CartesiDAppTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.Transact(opts, "transferOwnership", newOwner)
}
...
// WithdrawEther is a paid mutator transaction binding the crowdfunding method 0x522f6815.
//
...
func (_CartesiDApp *CartesiDAppTransactor) WithdrawEther(opts *bind.TransactOpts, _receiver common.Address, _value *big.Int) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.Transact(opts, "withdrawEther", _receiver, _value)
}
...
// Receive is a paid mutator transaction binding the crowdfunding receive function.
//
// Solidity: receive() payable returns()
func (_CartesiDApp *CartesiDAppTransactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CartesiDApp.crowdfunding.RawTransact(opts, nil) // calldata is disallowed for receive function
}
...
// CartesiDAppNewConsensusIterator is returned from FilterNewConsensus and is used to iterate over the raw logs and unpacked data for NewConsensus events raised by the CartesiDApp crowdfunding.
type CartesiDAppNewConsensusIterator struct {
	Event *CartesiDAppNewConsensus // Event containing the crowdfunding specifics and raw log
...
// CartesiDAppNewConsensus represents a NewConsensus event raised by the CartesiDApp crowdfunding.
type CartesiDAppNewConsensus struct {
	NewConsensus common.Address
	Raw          types.Log // Blockchain specific contextual infos
}

// FilterNewConsensus is a free log retrieval operation binding the crowdfunding event 0x4991c6f37185659e276ff918a96f3e20e6c5abcd8c9aab450dc19c2f7ad35cb5.
//
...
func (_CartesiDApp *CartesiDAppFilterer) FilterNewConsensus(opts *bind.FilterOpts) (*CartesiDAppNewConsensusIterator, error) {
	...
	logs, sub, err := _CartesiDApp.crowdfunding.FilterLogs(opts, "NewConsensus")
	if err != nil {
		return nil, err
	}
	return &CartesiDAppNewConsensusIterator{crowdfunding: _CartesiDApp.crowdfunding, event: "NewConsensus", logs: logs, sub: sub}, nil
}

// WatchNewConsensus is a free log subscription operation binding the crowdfunding event 0x4991c6f37185659e276ff918a96f3e20e6c5abcd8c9aab450dc19c2f7ad35cb5.
//
// Solidity: event NewConsensus(address newConsensus)
func (_CartesiDApp *CartesiDAppFilterer) WatchNewConsensus(opts *bind.WatchOpts, sink chan<- *CartesiDAppNewConsensus) (event.Subscription, error) {
	...
	logs, sub, err := _CartesiDApp.crowdfunding.WatchLogs(opts, "NewConsensus")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _CartesiDApp.crowdfunding.UnpackLog(event, "NewConsensus", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseNewConsensus is a log parse operation binding the crowdfunding event 0x4991c6f37185659e276ff918a96f3e20e6c5abcd8c9aab450dc19c2f7ad35cb5.
//
// Solidity: event NewConsensus(address newConsensus)
...
// CartesiDAppOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the CartesiDApp crowdfunding.
type CartesiDAppOwnershipTransferredIterator struct {
	Event *CartesiDAppOwnershipTransferred // Event containing the crowdfunding specifics and raw log
...
// CartesiDAppOwnershipTransferred represents a OwnershipTransferred event raised by the CartesiDApp crowdfunding.
...
// FilterOwnershipTransferred is a free log retrieval operation binding the crowdfunding event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
...
func (_CartesiDApp *CartesiDAppFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*CartesiDAppOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _CartesiDApp.crowdfunding.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &CartesiDAppOwnershipTransferredIterator{crowdfunding: _CartesiDApp.crowdfunding, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the crowdfunding event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_CartesiDApp *CartesiDAppFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *CartesiDAppOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _CartesiDApp.crowdfunding.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _CartesiDApp.crowdfunding.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseOwnershipTransferred is a log parse operation binding the crowdfunding event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
...
// CartesiDAppVoucherExecutedIterator is returned from FilterVoucherExecuted and is used to iterate over the raw logs and unpacked data for VoucherExecuted events raised by the CartesiDApp crowdfunding.
type CartesiDAppVoucherExecutedIterator struct {
	Event *CartesiDAppVoucherExecuted // Event containing the crowdfunding specifics and raw log
...
// CartesiDAppVoucherExecuted represents a VoucherExecuted event raised by the CartesiDApp crowdfunding.
type CartesiDAppVoucherExecuted struct {
	VoucherId *big.Int
	Raw       types.Log // Blockchain specific contextual infos
}

// FilterVoucherExecuted is a free log retrieval operation binding the crowdfunding event 0x0eb7ee080f865f1cadc4f54daf58cc3b8879e888832867d13351edcec0fbdc54.
//
...
func (_CartesiDApp *CartesiDAppFilterer) FilterVoucherExecuted(opts *bind.FilterOpts) (*CartesiDAppVoucherExecutedIterator, error) {
	...
	logs, sub, err := _CartesiDApp.crowdfunding.FilterLogs(opts, "VoucherExecuted")
	if err != nil {
		return nil, err
	}
	return &CartesiDAppVoucherExecutedIterator{crowdfunding: _CartesiDApp.crowdfunding, event: "VoucherExecuted", logs: logs, sub: sub}, nil
}

// WatchVoucherExecuted is a free log subscription operation binding the crowdfunding event 0x0eb7ee080f865f1cadc4f54daf58cc3b8879e888832867d13351edcec0fbdc54.
//
// Solidity: event VoucherExecuted(uint256 voucherId)
func (_CartesiDApp *CartesiDAppFilterer) WatchVoucherExecuted(opts *bind.WatchOpts, sink chan<- *CartesiDAppVoucherExecuted) (event.Subscription, error) {
	...
	logs, sub, err := _CartesiDApp.crowdfunding.WatchLogs(opts, "VoucherExecuted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _CartesiDApp.crowdfunding.UnpackLog(event, "VoucherExecuted", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseVoucherExecuted is a log parse operation binding the crowdfunding event 0x0eb7ee080f865f1cadc4f54daf58cc3b8879e888832867d13351edcec0fbdc54.
//
// Solidity: event VoucherExecuted(uint256 voucherId)
