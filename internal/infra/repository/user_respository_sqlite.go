...
func (r *UserRepositorySqlite) FindUserByAddress(ctx context.Context, address custom_type.Address) (*entity.User, error) {
...
func (r *UserRepositorySqlite) DeleteUser(ctx context.Context, address custom_type.Address) error {
