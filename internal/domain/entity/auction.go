...
func NewAuction(creator custom_type.Address, debt_issued custom_type.BigInt, maxInterestRate custom_type.BigInt, expiresAt int64, createdAt int64) (*Auction, error) {
	auction := &Auction{
		Creator:         creator,
...
func (a *Auction) Validate() error {
	if a.Creator.Address == (common.Address{}) || a.DebtIssued.Int.Sign() == 0 || a.MaxInterestRate.Int.Sign() == 0 || a.ExpiresAt == 0 || a.CreatedAt == 0 || a.CreatedAt >= a.ExpiresAt {
